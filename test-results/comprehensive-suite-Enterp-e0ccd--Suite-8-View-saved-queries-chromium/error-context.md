...
- Name: comprehensive-suite.spec.ts >> Enterprise Reporting System - Comprehensive Suite >> 8. View saved queries
- Location: e2e/comprehensive-suite.spec.ts:348:3
...
Locator: locator('text=Saved Queries').or(locator('h1:has-text("Query")'))
Expected: visible
Error: strict mode violation: locator('text=Saved Queries').or(locator('h1:has-text("Query")')) resolved to 2 elements:
    1) <span>Saved Queries</span> aka getByRole('button', { name: 'Saved Queries' })
    2) <h1 class="text-2xl font-bold">Saved Queries</h1> aka getByRole('heading', { name: 'Saved Queries' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Saved Queries').or(locator('h1:has-text("Query")'))
    ...
    - generic [ref=e112]:
      ...
      - main [ref=e136]:
        - generic [ref=e137]:
          - generic [ref=e138]:
            - generic [ref=e139]:
              - heading "Saved Queries" [level=1] [ref=e140]
              - paragraph [ref=e141]: Manage your saved SQL queries
            - button "New Query" [ref=e142] [cursor=pointer]:
              - img [ref=e143]
              - text: New Query
          - generic [ref=e144]:
            - generic [ref=e145]:
              - img [ref=e146]
              - textbox "Search by name, description, or data source..." [ref=e149]
            - button "Refresh" [ref=e150] [cursor=pointer]:
              - img [ref=e151]
              - text: Refresh
          - table [ref=e158]:
            - rowgroup [ref=e159]:
              - row "Name Description Data Source Created Modified Actions" [ref=e160]:
                - columnheader "Name" [ref=e161]
                - columnheader "Description" [ref=e162]
                - columnheader "Data Source" [ref=e163]
                - columnheader "Created" [ref=e164]
                - columnheader "Modified" [ref=e165]
                - columnheader "Actions" [ref=e166]
            - rowgroup [ref=e167]:
              - row "No saved queries found. Create your first query" [ref=e168]:
                - cell "No saved queries found. Create your first query" [ref=e169]:
                  - generic [ref=e170]:
                    - paragraph [ref=e171]: No saved queries found.
                    - button "Create your first query" [ref=e172] [cursor=pointer]
