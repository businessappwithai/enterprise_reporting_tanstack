...
- Name: load-comprehensive.spec.ts >> Reports and Charts >> R3. Dashboards page loads
- Location: e2e/load-comprehensive.spec.ts:342:3
...
Locator: locator('h1').or(locator('text=Dashboard')).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').or(locator('text=Dashboard')).first()
