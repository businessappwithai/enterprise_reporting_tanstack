...
- Name: comprehensive-suite.spec.ts >> Enterprise Reporting System - Comprehensive Suite >> 23. Notifications panel
- Location: e2e/comprehensive-suite.spec.ts:527:3
...
Locator: [role="dialog"], .popover, text=Notifications >> internal:or="text=No notifications"
Expected: visible
Error: Unexpected token "=" while parsing css selector "[role="dialog"], .popover, text=Notifications". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for [role="dialog"], .popover, text=Notifications >> internal:or="text=No notifications"
    ...
    - generic [ref=e112]:
      - banner [ref=e113]:
        ...
        - generic [ref=e122]:
          ...
          - button "Notifications" [active] [ref=e131] [cursor=pointer]:
            - img [ref=e132]
