...
- Name: api-logging-encryption.spec.ts >> API - SQL Execution with Logging >> should execute simple SELECT query
- Location: e2e/api-logging-encryption.spec.ts:198:3
