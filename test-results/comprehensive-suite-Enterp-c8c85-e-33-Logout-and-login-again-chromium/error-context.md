...
- Name: comprehensive-suite.spec.ts >> Enterprise Reporting System - Comprehensive Suite >> 33. Logout and login again
- Location: e2e/comprehensive-suite.spec.ts:678:3
...
Call log:
  - waiting for locator('button:has-text("Logout"), [aria-label*="logout"], button:has-text("Sign out")')
