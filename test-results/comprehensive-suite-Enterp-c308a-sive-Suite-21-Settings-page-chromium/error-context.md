...
- Name: comprehensive-suite.spec.ts >> Enterprise Reporting System - Comprehensive Suite >> 21. Settings page
- Location: e2e/comprehensive-suite.spec.ts:502:3
...
Call log:
  ...
  - waiting for locator('text=Settings').or(locator('h1'))
