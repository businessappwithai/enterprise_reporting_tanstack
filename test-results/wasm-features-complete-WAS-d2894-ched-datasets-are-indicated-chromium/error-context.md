...
- Name: wasm-features-complete.spec.ts >> WASM Features - Offline Mode >> WASM-017: Cached datasets are indicated
- Location: e2e/wasm-features-complete.spec.ts:310:3
  ...
  - dialog "Error Report" [ref=e2]:
    ...
    - generic [ref=e9]:
      - generic [ref=e10]:
        ...
        - paragraph [ref=e12]: 2026-05-14T05:40:56.661Z
      - generic [ref=e13]:
