...
- Name: complete-system-test.spec.ts >> Complete System Test Suite >> Filters >> 7.1 Can view saved filters
- Location: e2e/complete-system-test.spec.ts:493:5
...
Locator: locator('h1').filter({ hasText: /filters/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').filter({ hasText: /filters/i })
  ...
  - dialog "Error Report" [ref=e2]:
    ...
    - generic [ref=e9]:
      - generic [ref=e10]:
        ...
        - paragraph [ref=e12]: 2026-05-14T05:19:15.905Z
      - generic [ref=e13]:
