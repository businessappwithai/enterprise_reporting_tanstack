...
- Name: comprehensive-suite.spec.ts >> Enterprise Reporting System - Comprehensive Suite >> 31. Complex GROUP BY with multiple dimensions
- Location: e2e/comprehensive-suite.spec.ts:656:3
...
Call log:
  - waiting for locator('.monono-editor, [contenteditable="true"], textarea').first()
