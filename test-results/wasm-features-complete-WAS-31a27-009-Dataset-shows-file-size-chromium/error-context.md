...
- Name: wasm-features-complete.spec.ts >> WASM Features - Datasets >> WASM-009: Dataset shows file size
- Location: e2e/wasm-features-complete.spec.ts:162:3

# Error details

```
Error: locator.isVisible: SyntaxError: Invalid flags supplied to RegExp constructor 'i, .file-size'
...
Call log:
    - checking visibility of locator('text=/MB|KB|GB/i, .file-size')
  ...
  - dialog "Error Report" [ref=e2]:
    ...
    - generic [ref=e9]:
      - generic [ref=e10]:
        ...
        - paragraph [ref=e12]: 2026-05-14T05:40:04.005Z
      - generic [ref=e13]:
