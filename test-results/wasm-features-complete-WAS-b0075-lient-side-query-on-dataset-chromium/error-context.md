...
- Name: wasm-features-complete.spec.ts >> WASM Features - DuckDB Integration >> WASM-012: Can execute client-side query on dataset
- Location: e2e/wasm-features-complete.spec.ts:216:3
