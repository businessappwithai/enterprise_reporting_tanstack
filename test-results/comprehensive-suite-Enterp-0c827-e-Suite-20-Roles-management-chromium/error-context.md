...
Expected: visible
Error: strict mode violation: locator('text=Roles').or(locator('h1')) resolved to 8 elements:
    1) <span>Roles</span> aka getByRole('button', { name: 'Roles' })
    ...
    4) <a href="/admin/roles" aria-current="page" data-status="active" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 active">Roles</a> aka getByRole('main').getByRole('link', { name: 'Roles' })
    5) <h1 class="text-2xl font-bold">Role Management</h1> aka getByRole('heading', { name: 'Role Management' })
    6) <p class="text-muted-foreground">Manage roles and their granular permissions</p> aka getByText('Manage roles and their')
    7) <h3 class="text-lg font-semibold leading-none tracking-tight flex items-center gap-2">…</h3> aka getByRole('heading', { name: 'All Roles' })
    8) <div class="text-center py-8 text-muted-foreground">Loading roles...</div> aka getByText('Loading roles...')
      ...
      - main [ref=e136]:
        - generic [ref=e137]:
          ...
          - generic [ref=e145]:
            - generic [ref=e146]:
              - generic [ref=e147]:
                - heading "Role Management" [level=1] [ref=e148]
                - paragraph [ref=e149]: Manage roles and their granular permissions
              - button "Create Role" [ref=e150] [cursor=pointer]:
                - img [ref=e151]
                - text: Create Role
            - generic [ref=e153]:
              - heading "All Roles" [level=3] [ref=e155]:
                - img [ref=e156]
                - text: All Roles
              - generic [ref=e159]: Loading roles...
