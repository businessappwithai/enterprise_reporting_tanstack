...
- Name: comprehensive-suite.spec.ts >> Enterprise Reporting System - Comprehensive Suite >> 20. Roles management
- Location: e2e/comprehensive-suite.spec.ts:495:3
...
Locator: locator('text=Roles').or(locator('h1'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Roles').or(locator('h1'))
