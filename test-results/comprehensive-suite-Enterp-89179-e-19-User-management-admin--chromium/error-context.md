...
- Name: comprehensive-suite.spec.ts >> Enterprise Reporting System - Comprehensive Suite >> 19. User management (admin)
- Location: e2e/comprehensive-suite.spec.ts:488:3
...
Call log:
  ...
  - waiting for locator('text=Users').or(locator('h1'))
