...
- Name: wasm-features-complete.spec.ts >> WASM Features - Offline Mode >> WASM-016: Offline indicator shows connection status
- Location: e2e/wasm-features-complete.spec.ts:296:3

# Error details

```
Error: locator.isVisible: Unexpected token "=" while parsing css selector "[data-testid="offline-indicator"], .offline-status, text=/online|offline/i". Did you mean to CSS.escape it?
Call log:
    - checking visibility of [data-testid="offline-indicator"], .offline-status, text=/online|offline/i
  ...
  - dialog "Error Report" [ref=e2]:
    ...
    - generic [ref=e9]:
      - generic [ref=e10]:
        ...
        - paragraph [ref=e12]: 2026-05-14T05:40:53.181Z
      - generic [ref=e13]:
