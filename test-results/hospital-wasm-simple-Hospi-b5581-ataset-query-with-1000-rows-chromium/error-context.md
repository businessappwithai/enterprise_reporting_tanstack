...
- Name: hospital-wasm-simple.spec.ts >> Hospital Management - WASM Performance Test >> Large dataset query with 1000 rows
- Location: e2e/hospital-wasm-simple.spec.ts:71:3
