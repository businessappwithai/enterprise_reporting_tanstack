...
- Name: complete-system-test.spec.ts >> Complete System Test Suite >> Settings >> 14.1 Can access email settings
- Location: e2e/complete-system-test.spec.ts:941:5
...
Locator: locator('h1').filter({ hasText: /email/i }).or(locator('h1').filter({ hasText: /settings/i }))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').filter({ hasText: /email/i }).or(locator('h1').filter({ hasText: /settings/i }))
