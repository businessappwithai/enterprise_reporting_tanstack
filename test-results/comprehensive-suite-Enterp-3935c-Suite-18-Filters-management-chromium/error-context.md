...
- Name: comprehensive-suite.spec.ts >> Enterprise Reporting System - Comprehensive Suite >> 18. Filters management
- Location: e2e/comprehensive-suite.spec.ts:481:3
...
Locator: locator('text=Filters').or(locator('h1'))
Expected: visible
Error: strict mode violation: locator('text=Filters').or(locator('h1')) resolved to 2 elements:
    1) <span>Filters</span> aka getByRole('button', { name: 'Filters' })
    2) <p class="text-muted-foreground">Loading filters...</p> aka getByText('Loading filters...')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Filters').or(locator('h1'))
      ...
      - banner [ref=e113]:
        ...
        - generic [ref=e119]:
          ...
          - button "SA" [ref=e133] [cursor=pointer]:
            - generic [ref=e135]: SA
      - main [ref=e136]:
        - paragraph [ref=e138]: Loading filters...
