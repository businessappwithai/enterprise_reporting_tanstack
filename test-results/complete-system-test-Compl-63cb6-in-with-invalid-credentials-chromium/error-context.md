...
- Name: complete-system-test.spec.ts >> Complete System Test Suite >> Authentication & Authorization >> 1.2 User cannot login with invalid credentials
- Location: e2e/complete-system-test.spec.ts:60:5
