...
- Name: complete-system-test.spec.ts >> Complete System Test Suite >> Authentication & Authorization >> 1.4 Unauthenticated user is redirected to login
- Location: e2e/complete-system-test.spec.ts:83:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4050/reports
Call log:
  - navigating to "http://localhost:4050/reports", waiting until "load"
