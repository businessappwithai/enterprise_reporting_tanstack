...
- Name: wasm-features-complete.spec.ts >> WASM Features - Error Handling >> WASM-031: Handles WASM initialization failure gracefully
- Location: e2e/wasm-features-complete.spec.ts:644:3
