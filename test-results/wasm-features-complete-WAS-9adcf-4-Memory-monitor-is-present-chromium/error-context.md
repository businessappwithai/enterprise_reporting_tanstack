...
- Name: wasm-features-complete.spec.ts >> WASM Features - DuckDB Integration >> WASM-014: Memory monitor is present
- Location: e2e/wasm-features-complete.spec.ts:262:3

# Error details

```
Error: locator.isVisible: Unexpected token "=" while parsing css selector ".memory-monitor, [data-testid="memory-usage"], text=/memory/i". Did you mean to CSS.escape it?
Call log:
    - checking visibility of .memory-monitor, [data-testid="memory-usage"], text=/memory/i
  ...
  - dialog "Error Report" [ref=e2]:
    ...
    - generic [ref=e9]:
      - generic [ref=e10]:
        ...
        - paragraph [ref=e12]: 2026-05-14T05:40:45.074Z
      - generic [ref=e13]:
