...
- Name: complete-system-test.spec.ts >> Complete System Test Suite >> Metadata Entities >> 8.2 Can create a metadata entity
- Location: e2e/complete-system-test.spec.ts:568:5
...
Call log:
  - waiting for locator('button:has-text("New Entity"), button:has-text("Create Entity")')
