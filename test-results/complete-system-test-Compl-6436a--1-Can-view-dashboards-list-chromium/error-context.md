...
- Name: complete-system-test.spec.ts >> Complete System Test Suite >> Dashboards >> 6.1 Can view dashboards list
- Location: e2e/complete-system-test.spec.ts:418:5
...
Locator: locator('h1').filter({ hasText: /dashboards/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').filter({ hasText: /dashboards/i })
