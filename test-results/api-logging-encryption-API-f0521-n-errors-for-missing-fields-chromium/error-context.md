...
- Name: api-logging-encryption.spec.ts >> API - Error Logging Scenarios >> should log validation errors for missing fields
- Location: e2e/api-logging-encryption.spec.ts:375:3
