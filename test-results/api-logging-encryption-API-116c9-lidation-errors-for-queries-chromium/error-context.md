...
- Name: api-logging-encryption.spec.ts >> API - Error Logging Scenarios >> should log validation errors for queries
- Location: e2e/api-logging-encryption.spec.ts:390:3
