...
- Name: load-comprehensive.spec.ts >> Admin Functions >> ADM2. Roles page loads
- Location: e2e/load-comprehensive.spec.ts:365:3
...
Locator: locator('h1').or(locator('text=Role')).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').or(locator('text=Role')).first()
