...
- Name: complete-system-test.spec.ts >> Complete System Test Suite >> Data Source Management >> 2.1 Can view data sources list
- Location: e2e/complete-system-test.spec.ts:101:5
...
Locator: locator('table, [role="table"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('table, [role="table"]')
