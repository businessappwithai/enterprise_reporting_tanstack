...
- Name: complete-system-test.spec.ts >> Complete System Test Suite >> Jobs >> 9.2 Can view job executions
- Location: e2e/complete-system-test.spec.ts:634:5
    ...
    - generic [ref=e112]:
      ...
      - main [ref=e139]:
        - generic [ref=e140]:
          ...
          - generic [ref=e195]:
            - tablist [ref=e196]:
              - tab "Recent Executions" [active] [selected] [ref=e197] [cursor=pointer]
