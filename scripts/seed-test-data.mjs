...
function seedDatabase() {
  try {
    ...
    const insertDataSource = db.prepare(`
      ...
      (id, name, description, client_type, connection_config, created_by, created_at, updated_at)
      VALUES (?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
    `);
    ...
    const insertQuery = db.prepare(`
      ...
      (id, name, description, sql_content, data_source_id, created_by, created_at, updated_at)
      VALUES (?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
    `);
