      ...
      PUT: async ({ request, params }: { request: Request; params: { id: string } }) => {
        try {
          ...
          const body = await request.json() as {
            name?: string; description?: string; metricColumn?: string;
            thresholdOperator?: ThresholdOperator; thresholdValue?: number;
            thresholdUpperBound?: number; escalationThresholdPct?: number;
            alertChannels?: AlertChannel[]; alertRecipients?: AlertRecipient[];
