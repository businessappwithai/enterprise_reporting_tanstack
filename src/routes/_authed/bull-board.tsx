...
import {
  RefreshCw, Play, Pause, Trash2, Clock, CheckCircle2, XCircle, AlertCircle, Activity,
} from 'lucide-react'
        ...
        <CardContent>
          {isLoadingJobs ? (
            ...
            <div className="space-y-2">
              {jobs.map((job: { id: string; name: string; status: string; progress?: number; failedReason?: string; timestamp?: number }) => (
