                ...
                <div className="space-y-4">
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Sent when a scheduled job completes successfully. Includes job details,
                      execution time, and download link for the report.
                    </p>
                    <div className="text-xs text-muted-foreground">
                      <strong>Variables:</strong> jobName, userName, status, completedAt, duration,
                      rowCount, resultUrl
                    </div>
                  </div>
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Sent when a scheduled job fails. Includes error details and troubleshooting
                      information.
                    </p>
                    <div className="text-xs text-muted-foreground">
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Template for testing email configuration. Confirms SMTP settings are working
                      correctly.
                    </p>
                    <div className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-4">
                  💡 When creating a job, enable &ldquo;Email Report&rdquo; to attach the exported
                  file and send it to configured recipients
                </p>
              </CardContent>
            </Card>
          </div>
