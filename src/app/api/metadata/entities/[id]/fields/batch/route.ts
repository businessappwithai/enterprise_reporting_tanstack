  ...
  try {
    ...
    if (updates.length === 0) {
      return NextResponse.json(
        {
          success: false,
          error: { code: "VALIDATION_ERROR", message: "updates array cannot be empty" },
        },
        { status: 400 }
      );
    }
      ...
      return NextResponse.json(
        {
          ...
          error: {
            ...
            message: "Cannot update more than 100 fields at once",
          },
        },
        { status: 400 }
      );
    ...
    for (const update of updates) {
      if (!update.id || typeof update.id !== "string") {
        return NextResponse.json(
          {
            success: false,
            error: { code: "VALIDATION_ERROR", message: "Each update must have a valid id field" },
          },
          { status: 400 }
        );
      }
      ...
      if (!update.data || typeof update.data !== "object") {
        return NextResponse.json(
          {
            success: false,
            error: { code: "VALIDATION_ERROR", message: "Each update must have a data object" },
          },
          { status: 400 }
        );
      }
        ...
        return NextResponse.json(
          {
            ...
            error: {
              code: "VALIDATION_ERROR",
              message: `description must be a string for field ${update.id}`,
            },
          },
          { status: 400 }
        );
        ...
        return NextResponse.json(
          {
            ...
            error: {
              code: "VALIDATION_ERROR",
              message: `is_display_field must be a boolean for field ${update.id}`,
            },
          },
          { status: 400 }
        );
        ...
        return NextResponse.json(
          {
            ...
            error: {
              code: "VALIDATION_ERROR",
              message: `is_searchable must be a boolean for field ${update.id}`,
            },
          },
          { status: 400 }
        );
        ...
        return NextResponse.json(
          {
            ...
            error: {
              code: "VALIDATION_ERROR",
              message: `display_order must be a number for field ${update.id}`,
            },
          },
          { status: 400 }
        );
          ...
          return NextResponse.json(
            {
              ...
              error: {
                code: "VALIDATION_ERROR",
                message: `relationship_ui_type must be dropdown, popup, or null for field ${update.id}`,
              },
            },
            { status: 400 }
          );
        ...
        return NextResponse.json(
          {
            ...
            error: {
              code: "VALIDATION_ERROR",
              message: `description exceeds maximum length of 1000 characters for field ${update.id}`,
            },
          },
          { status: 400 }
        );
