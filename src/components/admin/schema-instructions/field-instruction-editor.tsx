    ...
    >
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="flex items-center space-x-2">
          <Checkbox
            id="nullable"
            checked={fieldMetadata?.isNullable ?? true}
            disabled
          />
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            id="primary-key"
            checked={fieldMetadata?.isPrimaryKey ?? false}
            disabled
          />
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            id="foreign-key"
            checked={fieldMetadata?.isForeignKey ?? false}
            disabled
          />
      ...
      {fieldMetadata?.isForeignKey && (
        <div className="grid grid-cols-2 gap-4 p-3 bg-muted rounded">
          <div className="space-y-2">
            <Label htmlFor="fk-table" className="text-sm">FK Table</Label>
            <Input
              id="fk-table"
          ...
          <div className="space-y-2">
            <Label htmlFor="fk-field" className="text-sm">FK Field</Label>
            <Input
              id="fk-field"
