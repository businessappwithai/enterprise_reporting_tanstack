...
export class AdvancedCharts {
  static buildHeatmap(config: EChartsConfig, rows: Record<string, unknown>[]): EChartsOption {
  ...
  static buildTreemap(config: EChartsConfig, rows: Record<string, unknown>[]): EChartsOption {
    const valueCol = Array.isArray(config.dataMapping.y)
      ? config.dataMapping.y[0]
      : (config.dataMapping.y ?? "");
  ...
  static buildSunburst(config: EChartsConfig, rows: Record<string, unknown>[]): EChartsOption {
    const valueCol = Array.isArray(config.dataMapping.y)
      ? config.dataMapping.y[0]
      : (config.dataMapping.y ?? "");
    const data = rows.map((r) => ({
  ...
  static buildFunnel(config: EChartsConfig, rows: Record<string, unknown>[]): EChartsOption {
    const valueCol = Array.isArray(config.dataMapping.y)
      ? config.dataMapping.y[0]
      : (config.dataMapping.y ?? "");
    const data = rows.map((r) => ({
  ...
  static buildGauge(config: EChartsConfig, rows: Record<string, unknown>[]): EChartsOption {
  ...
  static buildSankey(config: EChartsConfig, rows: Record<string, unknown>[]): EChartsOption {
    const valueCol = Array.isArray(config.dataMapping.y)
      ? config.dataMapping.y[0]
      : (config.dataMapping.y ?? "");
