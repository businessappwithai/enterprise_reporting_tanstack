...
export class BasicCharts {
  static buildBar(
    ...
    console.log('[BasicCharts.buildBar] Series:', seriesWithStack.map((s) => ({
      name: s.name,
      hasStack: 'stack' in s,
      stackValue: s.stack,
    ...
    console.log('[BasicCharts.buildBar] First series object:', JSON.stringify(seriesWithStack[0], null, 2));
    console.log('[BasicCharts.buildBar] Second series object:', JSON.stringify(seriesWithStack[1], null, 2));
