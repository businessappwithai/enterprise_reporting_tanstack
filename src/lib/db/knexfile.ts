...
const config: { [key: string]: Knex.Config } = {
  ...
  production: DATABASE_URL
    ? { ...pgConfig, migrations: { ...pgConfig.migrations, extension: 'js' }, seeds: { ...pgConfig.seeds, extension: 'js' } }
    : { ...sqliteConfig, client: 'better-sqlite3', migrations: { ...sqliteConfig.migrations, extension: 'js' }, seeds: { ...sqliteConfig.seeds, extension: 'js' } },
}
